        ...
        <div className="mx-auto mb-10 max-w-2xl">
          ...
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-[var(--vt-muted)]">
            {canOpenPortal
              ...
              : `${customerName} — you’re on ${currentPlanLabel}. Compare plans and upgrade from the pricing page.`}
          </p>
        </div>

        {!canOpenPortal ? (
          <div className="mx-auto max-w-xl rounded-2xl border border-white/10 bg-white/[0.04] p-6 sm:p-8">
            <p className="text-sm leading-relaxed text-[var(--vt-muted)]">
              Plan options and Stripe checkout live on the dedicated pricing page. After you pay, you&apos;ll return here
              and your tier updates automatically.
            </p>
