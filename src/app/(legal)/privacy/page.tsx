...
export default function PrivacyPage() {
  return (
    <LegalDocument
      eyebrow="Legal"
      title="Privacy Policy"
      summary="This policy explains what verify.trading collects, how it is collected, what it is used for, and every third party it is shared with — including the AI services that process your questions and your voice. Last updated 28 August 2026."
      sections={[
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Account details, which you give us directly when you sign up: your email address, an authentication identifier, and — if you sign in with Apple or Google — the identifier that provider returns to us. We never receive your password for those providers.",
        ...
        },
        {
          ...
          paragraphs: [
            "Three features use third-party AI: Ask, the Mind Companion, and journal insights. Each asks separately, and nothing is sent to any of them until you have been shown what it sends and have explicitly agreed. You can decline any of them and keep using the rest of the product.",
            "Ask: when you send a question, the text you typed and any chart image you attached go to our servers and from there to a third-party AI gateway operating at pikachu.hueling.cc, which routes the request to OpenAI’s GPT models. To answer questions about brokers and markets, the model also performs web searches and fetches public web pages; the search terms it generates are derived from your question and are handled by the same gateway.",
            "Mind Companion: when you start a call, your microphone audio is streamed from your device directly to ElevenLabs, which runs the speech recognition and the synthesised voice. ElevenLabs returns a transcript, which we store against your account so you can reread it. What the Companion says is generated by the same third-party AI gateway described above, which receives the running conversation and your assessment scores in order to reply in context.",
            "Journal insights: if you turn them on, the sessions you have journaled — your notes, lessons, moods and P&L — together with your prop-firm rules and your name are sent to the same gateway, which writes the weekly insight and the coaching line on each entry. This is off until you switch it on, and your journal, statistics and streaks all work without it.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "A third-party AI gateway operating at pikachu.hueling.cc — routes our requests to the underlying model providers, OpenAI (GPT) for Ask and the journal, Anthropic (Claude) for the Mind Companion, and performs the web searches Ask relies on. Receives your questions, attached images, journal entries, Companion conversation, and assessment scores.",
            "ElevenLabs — speech recognition and synthesised voice for Companion calls. Receives your microphone audio during a call and produces the transcript.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "You can also ask us to give you a copy of your data, correct it, restrict or object to how we use it, or withdraw a consent you previously gave — including your consent to the AI features, which you can withdraw by deleting your account or by writing to us.",
